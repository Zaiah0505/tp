...
class DoneMeetingCommandTest {
    ...
    public void execute_validIndexUnfilteredList_success() {
        Meeting meetingToComplete = model.getFilteredMeetingList().get(INDEX_FIRST_MEETING.getZeroBased());
        Meeting completedMeeting = completeMeeting(meetingToComplete);
        DoneMeetingCommand doneMeetingCommand = new DoneMeetingCommand(INDEX_FIRST_MEETING);
    ...
    @Test
    public void equals() {
        DoneMeetingCommand doneFirstCommand = new DoneMeetingCommand(INDEX_FIRST_MEETING);
        DoneMeetingCommand doneSecondCommand = new DoneMeetingCommand(INDEX_SECOND_MEETING);

        // same object -> returns true
        assertTrue(doneFirstCommand.equals(doneFirstCommand));

        // same values -> returns true
        DoneMeetingCommand doneFirstCommandCopy = new DoneMeetingCommand(INDEX_FIRST_MEETING);
